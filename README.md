...
Configure as Variáveis de Ambiente: Verifique o arquivo docker-compose.yml e ajuste, se necessário, as variáveis SYSTEM_EMAIL e SYSTEM_PASSWORD para o analysis_service.
